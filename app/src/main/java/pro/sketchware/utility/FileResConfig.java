...
public class FileResConfig {
    ...
    public FileResConfig(String sc_id) {
        ...
        String path = fpu.getPathPermission(numProj);
        String permissions = FileUtil.readFile(path);
        if (permissions.isEmpty()) return;

        try {
            listFilePermission = new Gson().fromJson(permissions, Helper.TYPE_STRING);
        } catch (Exception e) {
            // Handle corrupted or invalid JSON format
            listFilePermission = new ArrayList<>();
        }
    }
    ...
    public ArrayList<String> getJavaManifestList() {
        ...
        try {
            ...
            listJavaManifest = new ArrayList<>();
        }
    ...
    public ArrayList<String> getBroadcastManifestList() {
        ...
        try {
            ...
            listBroadcastManifest = new ArrayList<>();
        }
    ...
    public ArrayList<String> getServiceManifestList() {
        ...
        try {
            ...
            listServiceManifest = new ArrayList<>();
        }
